...
代码与工作流版本 **v0.4.0**：把长片实作中的人物表演、声音、真实插片检索、圆形画中画、字幕与动态设计、有限导出恢复沉淀为通用流程。人物外观按每位用户的要求锁定；不预设服饰、配饰、场景、性别或题材。详见 [更新记录](CHANGELOG.md) 与 [制作经验与根因](docs/PRODUCTION-LEARNINGS.md)。
